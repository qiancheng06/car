...
class LidarCoordinateControlNode(Node):
    def __init__(self):
        ...
        self.stop_brake_speed = -5.0  # 停车时给一点反向速度用于制动
        # AB模式参数（新增）
        ...
        self.lap_proximity_required = 4  # 连续命中次数，避免一次抖动误判
